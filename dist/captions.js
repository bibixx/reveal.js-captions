...
var revealElement = Reveal.getRevealElement();
revealElement.style.height = "calc(100% - 200px)";
var styles = 'initial';
var captionsHeight = 200;
var captionerBannerHeight = 61;
var h = 200 + captionerBannerHeight;

var initStyles = function initStyles($captionsElement) {
  styles = 'initial';
  $captionsElement.style.height = "".concat(h, "px");
  $captionsElement.style.width = "100%";
  $captionsElement.style.position = "relative";
};

var fullScreenStyles = function fullScreenStyles($captionsElement) {
  styles = 'fullscreen';
...
var $captionsElement = document.createElement('iframe');
